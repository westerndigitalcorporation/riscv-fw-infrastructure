...
/**
* @brief Setup and activate core Timer
*
* @parameter - uiPeriodCycles - defines the timer's period in cycles
*
***************************************************************************************************/
void pspTimerSetupCoreTimer(u32_t uiPeriodCycles)
{
...
void pspTimerCounterSetupAndRun(u32_t uiTimer, u32_t uiPeriodCycles)
{
	...
	M_PSP_ASSERT((D_PSP_CORE_TIMER == uiTimer) || (D_PSP_INTERNAL_TIMER0 == uiTimer) || (D_PSP_INTERNAL_TIMER1 == uiTimer));

	switch (uiTimer)
	{
		case D_PSP_CORE_TIMER:
			pspTimerSetupCoreTimer(uiPeriodCycles);
		    break;
