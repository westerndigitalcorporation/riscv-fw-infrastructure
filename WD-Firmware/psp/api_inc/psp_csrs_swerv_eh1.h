...
#define D_PSP_PIC_MEIGWCTRL_ADDR       PSP_PIC_BASE_ADDR + D_PSP_PIC_MEIGWCTRL_OFFSET	/* External interrupts gateway configuration */
...
#define D_PSP_PIC_MEIGWCLR_ADDR     PSP_PIC_BASE_ADDR + D_PSP_PIC_MEIGWCLR_OFFSET	/* External interrupts gateway clear */
