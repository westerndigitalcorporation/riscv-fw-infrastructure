...
void demoStart(void)
{
   ...
   while(1)
   {
	   g_uDemoTimer0Count = M_PSP_READ_PS_CSR(D_PSP_MITCNT0);
	   g_uDemoTimer1Count = M_PSP_READ_PS_CSR(D_PSP_MITCNT1);
...
void demoSetupTimer0(void)
{
    ...
    M_PSP_WRITE_PS_CSR(D_PSP_MITCNT0,0);
    /* Set Timer0 limit countup */
    M_PSP_WRITE_PS_CSR(D_PSP_MITBND0, 0xFF0000);
...
void demoSetupTimer1(void)
{
    ...
    M_PSP_WRITE_PS_CSR(D_PSP_MITCTL1,0);
    /* Set Timer1 limit countup */
    M_PSP_WRITE_PS_CSR(D_PSP_MITBND1, 0xFF0000);
